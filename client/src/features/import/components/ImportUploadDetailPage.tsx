        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/70 p-5 backdrop-blur-sm">
          <div className="bg-surface border border-surface-border rounded-2xl w-full max-w-md p-6 shadow-2xl">
            ...
            <button
              ...
              className="mt-4 w-full py-2 rounded-xl border border-surface-border text-fg-secondary hover:bg-surface-hover transition-colors"
            >
              Cancel
            </button>
          </div>
      ...
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th className="text-left text-muted font-semibold text-[11px] uppercase tracking-wider px-3 py-3 bg-surface-hover/40 border-b border-surface-border">SKU</th>
        ...
        <tbody>
          {rows.map((r) => (
            <tr key={r.id} className="border-t border-surface-border hover:bg-surface-hover transition-colors">
              ...
              <td className="px-3 py-2.5 text-[13px] text-fg tabular-nums">{r.resolvedSku ?? r.sku ?? '—'}</td>
      ...
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th className="text-left text-muted font-semibold text-[11px] uppercase tracking-wider px-3 py-3 bg-surface-hover/40 border-b border-surface-border">Price</th>
            <th className="text-left text-muted font-semibold text-[11px] uppercase tracking-wider px-3 py-3 bg-surface-hover/40 border-b border-surface-border">Confidence</th>
            <th className="text-left text-muted font-semibold text-[11px] uppercase tracking-wider px-3 py-3 bg-surface-hover/40 border-b border-surface-border">Proposed</th>
              ...
              <td className="px-3 py-2.5 text-right">
                <div className="flex gap-1 justify-end flex-wrap">
                  ...
                  <button
                    type="button"
                    onClick={() => onMatch(r)}
                    className="px-2.5 py-1 rounded-lg bg-surface border border-surface-border text-fg text-[11px] font-medium hover:bg-surface-hover transition-colors"
                  >
                    Match
                  </button>
                  <button
                  ...
                  <button
                    type="button"
                    onClick={() => onIgnore(r)}
                    className="px-2.5 py-1 rounded-lg text-danger text-[11px] font-medium hover:bg-danger-bg transition-colors"
                  >
                    Ignore
                  </button>
                </div>
