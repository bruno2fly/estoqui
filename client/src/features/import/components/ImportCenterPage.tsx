...
export function ImportCenterPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* App → Software sync. Staff scans on the phone populate this catalog —
          runs automatically on login; this card is the manual trigger + status. */}
      <div className="bg-surface border border-surface-border rounded-2xl p-6 shadow-sm">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-base font-semibold text-fg">Sync from the Estoqui App</h2>
            <p className="text-xs text-fg-secondary">
              Products your team scans on the phone appear here automatically.
              {lastSync?.ok && (
                <>
