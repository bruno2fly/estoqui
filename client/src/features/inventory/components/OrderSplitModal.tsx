        ...
        <table className="w-full text-xs">
          <thead className="sticky top-0 bg-surface z-10">
            <tr className="border-b border-surface-border">
              ...
              <th className="text-right text-muted font-semibold px-3 py-2 w-24">Total</th>
                  ...
                  <tr key={`${l.productId}-${i}`} className="border-b border-surface-border/50 hover:bg-surface-hover/50">
                    ...
                    <td className="px-3 py-1.5 text-center">
                      <input
                        ...
                        className="w-14 bg-input-bg border border-input-border text-fg text-center px-1.5 py-1 rounded-lg text-xs"
                      />
                    </td>
                    <td className="px-3 py-1.5 text-center">
                    ...
                    <td className="px-3 py-1.5 text-right font-medium text-fg">$ {l.lineTotal.toFixed(2)}</td>
