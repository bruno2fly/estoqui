...
export function Layout() {
  ...
  return (
    <>
      <aside className="hidden lg:flex w-[248px] flex-col bg-sidebar border-r border-sidebar-border shrink-0 overflow-y-auto">
      ...
      {mobileNavOpen && (
        <div className="fixed inset-0 z-[200] lg:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-[272px] max-w-[85vw] flex flex-col bg-sidebar border-r border-sidebar-border overflow-y-auto shadow-2xl">
        <div className="flex items-center gap-2.5 px-5 h-16 shrink-0">
          <img src="/estoqui-logo.png" alt="Estoqui" className="h-6 w-auto" />
        </div>
      ...
      <main className="flex-1 flex flex-col overflow-hidden bg-background">
        <header className="relative z-30 flex h-16 items-center gap-3 px-4 sm:px-6 bg-background/80 border-b border-surface-border shrink-0 backdrop-blur-md">
          <button
            type="button"
            onClick={() => setMobileNavOpen(true)}
            className="lg:hidden inline-flex size-9 shrink-0 items-center justify-center rounded-lg border border-surface-border bg-surface text-fg-secondary hover:text-fg transition-colors"
