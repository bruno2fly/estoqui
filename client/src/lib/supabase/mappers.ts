...
export function vendorToDb(v: Vendor, userId: string) {
  return {
    ...
    update_cadence: v.updateCadence ?? null,
    expected_update_day_of_week: v.expectedUpdateDayOfWeek ?? null,
    last_price_list_at: v.lastPriceListAt ?? null,
    stale_after_days: v.staleAfterDays ?? 7,
    score: v.score ?? null,
